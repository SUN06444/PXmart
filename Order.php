  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="Order.php">店取訂單系統</a></li>
...
?> 
    <tr>
      ...
      <td><?=$record['Oname']?></td>
      <td><?=$record['OCname']?></td>
      <td align="center"><?=$record['Oquantity']?></td>
      <td align="center"><?=$record['Oprice']?></td>
      <td align="center"><?=$record['Ocount']?></td>
       <td align="center"><?=$record['Ototal']?></td>
       <td ><?=$record['OSname']?></td>
        <td ><?=$record['Ostatus']?></td>
<?
}
?>
    </tr>
